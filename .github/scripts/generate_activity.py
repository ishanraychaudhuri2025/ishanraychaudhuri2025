...
def streak_card(theme, active_days, current, longest, current_start, current_end, longest_start, longest_end):
    ...
    # Exact current-streak geometry from github-readme-streak-stats,
    # with only the colors changed to this profile's palette.
...
<g clip-path="url(#outer)">
  ...
  <!-- CURRENT STREAK: exact reference geometry, static -->
  <g mask="url(#ringMask)">
  ...
  <!-- LONGEST STREAK: simple, centered filled trophy -->
  <g transform="translate(983.33 39)" fill="{gold}">
    <path d="M-9 -6 H9 V1 C9 7 5 11 0 13 C-5 11 -9 7 -9 1 Z"/>
    <path d="M-9 -3 H-15 V1 C-15 7 -12 11 -6 12 V8 C-9 7 -11 4 -11 0 H-9 Z"/>
    <path d="M9 -3 H15 V1 C15 7 12 11 6 12 V8 C9 7 11 4 11 0 H9 Z"/>
    <rect x="-3" y="13" width="6" height="7" rx="1"/>
    <rect x="-12" y="20" width="24" height="4" rx="2"/>
  </g>
