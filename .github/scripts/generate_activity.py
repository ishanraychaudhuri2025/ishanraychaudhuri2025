...
<g clip-path="url(#outer)" style="isolation:isolate">
  ...
  <!-- ACTIVE DAYS: keep approved design -->
  ...
  <text x="196.67" y="80" text-anchor="middle" fill="{accent}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="28" font-weight="700">{active_days}</text>
  <text x="196.67" y="116" text-anchor="middle" fill="{text}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="14" font-weight="400">Active Days</text>
  <text x="196.67" y="146" text-anchor="middle" fill="{muted}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="12" font-weight="400">last 400 days</text>

  <!-- CURRENT STREAK: exact github-readme-streak-stats geometry, recolored -->
  ...
  <!-- LONGEST STREAK: simple filled trophy, vertically aligned with Active Days -->
  <g transform="translate(983.33 35)" fill="{gold}">
    <path d="M-10 -5 H10 V2 C10 9 5 14 0 16 C-5 14 -10 9 -10 2 Z"/>
    <path d="M-10 -2 H-16 V2 C-16 9 -12 13 -7 14 V9 C-10 8 -12 5 -12 1 H-10 Z"/>
    <path d="M10 -2 H16 V2 C16 9 12 13 7 14 V9 C10 8 12 5 12 1 H10 Z"/>
    <rect x="-3" y="16" width="6" height="7" rx="1"/>
    <rect x="-12" y="23" width="24" height="4" rx="2"/>
  </g>
  <text x="983.33" y="80" text-anchor="middle" fill="{gold}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="28" font-weight="700">{longest}</text>
  <text x="983.33" y="116" text-anchor="middle" fill="{text}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="14" font-weight="400">Longest Streak</text>
  <text x="983.33" y="146" text-anchor="middle" fill="{muted}" font-family="\"Segoe UI\", Ubuntu, sans-serif" font-size="12" font-weight="400">{longest_range}</text>
</g>
</svg>'''
...
def frame(theme):
    ...
    return "".join([
        ...
        grp(streak, f"translate(16 16) scale({ss:.8f})"),
