...
<g clip-path="url(#outer)">
  ...
  <!-- LONGEST STREAK: trophy raised for visual alignment -->
  <g transform="translate(983.33 22)" fill="{gold}">
    ...
    <rect x="-11" y="20" width="22" height="4" rx="2"/>
  </g>
  <text x="983.33" y="86" text-anchor="middle" fill="{gold}" font-family="Segoe UI,Ubuntu,sans-serif" font-size="30" font-weight="700">{longest}</text>
  <text x="983.33" y="116" text-anchor="middle" fill="{gold}" font-family="Segoe UI,Ubuntu,sans-serif" font-size="14" font-weight="700">Longest Streak</text>
  <text x="983.33" y="143" text-anchor="middle" fill="{muted}" font-family="Segoe UI,Ubuntu,sans-serif" font-size="12">{longest_range}</text>
  <rect x="958" y="153" width="51" height="4" rx="2" fill="{gold}"/>
</g>
</svg>'''
