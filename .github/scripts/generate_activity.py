...
FRAME_RED = "#4A0E18"
REFERENCE_FIRE_PNG = ""
...
<g clip-path="url(#outer)">
  ...
  <g transform="translate(196.67 40)" fill="none" stroke="{accent}" stroke-width="2">
    ...
    <line x1="6" y1="-12" x2="6" y2="-5"/>
    <circle cx="-5" cy="4" r="1.2" fill="{accent}" stroke="none"/><circle cx="0" cy="4" r="1.2" fill="{accent}" stroke="none"/><circle cx="5" cy="4" r="1.2" fill="{accent}" stroke="none"/>
  </g>
  ...
  <!-- CURRENT STREAK: exact uploaded reference flame, recolored to profile gold -->
  <circle cx="590" cy="68" r="34" fill="none" stroke="{accent}" stroke-width="5"/>
  <image href="data:image/png;base64,{REFERENCE_FIRE_PNG}" x="576" y="2" width="29" height="31" preserveAspectRatio="none" style="filter:brightness(0) saturate(100%) invert(73%) sepia(45%) saturate(630%) hue-rotate(5deg) brightness(91%) contrast(88%);"/>
  ...
  <text x="590" y="116" text-anchor="middle" fill="{gold}" font-family="Segoe UI,Ubuntu,sans-serif" font-size="14" font-weight="700">Current Streak</text>
  ...
  <!-- LONGEST STREAK: premium filled championship cup -->
  <g transform="translate(983.33 38)" fill="{gold}">
    <path d="M-11 -4 H11 V5 C11 14 6 20 0 22 C-6 20 -11 14 -11 5 Z"/>
    <path d="M-11 -1 H-18 V4 C-18 12 -14 17 -7 18 V13 C-11 11 -13 8 -13 3 H-11 Z"/>
    <path d="M11 -1 H18 V4 C18 12 14 17 7 18 V13 C11 11 13 8 13 3 H11 Z"/>
    <path d="M-4 22 H4 V30 H-4 Z"/>
    <rect x="-13" y="29" width="26" height="5" rx="2"/>
    <path d="M-7 1 H7 V6 C7 11 4 15 0 15 C-4 15 -7 11 -7 6 Z" fill="{bg}" opacity="0.22"/>
    <path d="M-2 -1 H2 V4 H-2 Z" fill="{bg}" opacity="0.28"/>
  </g>
